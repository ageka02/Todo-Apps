...
function undoTaskFromCompleted(todoId /* HTMLELement */) {
  ...
  document.dispatchEvent(new Event(RENDER_EVENT));
  saveData('Todo set to uncompleted');
}
...
function saveData(text) {
  if (isStorageExist()) {
    ...
    document.dispatchEvent(new CustomEvent(SAVED_EVENT, {detail:text}));
  }
}
...
document.addEventListener(SAVED_EVENT, function (e) {
  ...
  const eventText = e.detail;

  eventText !== '' ? Toast(eventText) : Toast('ahahah')
});
